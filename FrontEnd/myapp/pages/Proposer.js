...
export default function Proposer() {
  ...
  useEffect(() => {
    ...
    (async function () {
      try {
        ...
        const oldEvents = await contract.queryFilter(filter, deployTx.blockNumber, 'latest');
  ...
  return (
    <>
      ...
      <Layout>
      {isConnected ? (
        <div justifyContent="center" alignItems="center" width="100%" Top="0">
          <h1>Admin Panel</h1>
          <br/><br/>
          <div>
            <h2>Add a Proposer :</h2>
              <Input
              placeholder="address"
